...
public class ApiCallbackGetShipmentItems implements ApiCallback<GetShipmentItemsResponse> {
	...
	public ApiCallbackGetShipmentItems(IFulfillmentInboundService iFulfillmentInboundService,IShipInboundItemService iShipInboundItemService,
		...
		this.iShipInboundItemService=iShipInboundItemService;
		this.auth=auth;
		this.market=market;
