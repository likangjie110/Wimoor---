...
public class ReportController {
    ...
    public Result<?> dataAnalysisAction() {
    	...
    	summaryOrderReportService.dataAnalysis(null);
    	return Result.success();
    }
    ...
    public Result<String> uploadExcelAction(@RequestParam("file")MultipartFile file,@RequestParam("amazonauthid")String amazonauthid
    		,@RequestParam("requesttype")String requesttype)  {
    	try {
			InputStream inputStream = file.getInputStream();
			AmazonAuthority amazonAuthority = amazonAuthorityService.getById(amazonauthid);
			BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(inputStream));
			return Result.success(handlerReportService.treatReportFile(requesttype, amazonAuthority, bufferedReader));
		} catch (IOException e) {
