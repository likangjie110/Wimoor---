...
public interface InplaceFeeFormatMapper  extends BaseMapper<InplaceFeeFormat> {
	...
	InplaceFeeFormat findByInvplaceFeeId(@Param("invplaceFee")String invplaceFee, @Param("isStandard")boolean isStandard, @Param("country")String country,@Param("producttierId") String producttierId);
