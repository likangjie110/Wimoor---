...
public interface ISummaryDataService  extends IService<SummaryData>{
	...
	public ChartLine findOrderSummaryBySku(String groupid,String amazonAuthId, String sku,String asin, String marketplaceid,Integer daysize ,String linetype, UserInfo user);
}
