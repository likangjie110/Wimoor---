			...
			while ((line = br.readLine()) != null) {
				...
				if (lineNumber == 0) {
					...
					LambdaQueryWrapper<FBAReimbursementsFeeReport> queryWrapper=new LambdaQueryWrapper<FBAReimbursementsFeeReport>();
 					...
 					queryWrapper.eq(FBAReimbursementsFeeReport::getAmazonOrderId, report.getAmazonOrderId());
 					queryWrapper.eq(FBAReimbursementsFeeReport::getReimbursementId, report.getReimbursementId());
 					queryWrapper.eq(FBAReimbursementsFeeReport::getSku, report.getSku());
 					queryWrapper.eq(FBAReimbursementsFeeReport::getReason, report.getReason());
