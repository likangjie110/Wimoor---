...
@Mapper
public interface ShipInboundShipmentV2Mapper extends BaseMapper<ShipInboundShipment> {
	...
	List<Map<String,Object>> findByTraceConditionCenter(@Param("param")ShipInboundShipmenSummaryDTO param);
	...
	List<LinkedHashMap<String, Object>> findBoxByShipmentId(@Param("shipmentid") String shipmentid);
	...
	List<ShipInboundShipment> listRefreshShipment(@Param("amazonauthId")String amazonauthId);
}