...
//					    item-extensions-data
						...
						if(StrUtil.isEmpty(purchase_date)||StrUtil.isEmpty(last_updated_date))continue;
						...
						if(begin==null||begin.after(record.getPurchaseDate()))begin=record.getPurchaseDate();
						if(end==null||end.before(record.getPurchaseDate()))end=record.getPurchaseDate();
