...
import com.wimoor.amazon.orders.service.IOrderFBMReturnService;
...
@Service("orderFBMReturnService")
public class OrderFBMReturnServiceImpl implements IOrderFBMReturnService{
	@Autowired
	...
	@Autowired
	AmzOrderFBMReturnsMapper amzOrderFBMReturnsMapper;
	@Resource
	...
	public IPage<AmazonOrdersReturnVo> selectReturnsList(AmazonOrdersReturnDTO condition) {
		 ...
		 IPage<AmazonOrdersReturnVo> list = amzOrderFBMReturnsMapper.selectReturnsList(condition.getPage(),condition);
	...
	public void downloadReturnlist(SXSSFWorkbook workbook,AmazonOrdersReturnDTO condition) {
		AmazonAuthority auth = amazonAuthorityService.getById(condition.getAmazonauthid());
		 ...
		 List<AmazonOrdersReturnVo> list = amzOrderFBMReturnsMapper.selectReturnsList(condition);
