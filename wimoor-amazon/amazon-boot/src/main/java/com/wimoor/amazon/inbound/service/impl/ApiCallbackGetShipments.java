...
public class ApiCallbackGetShipments implements ApiCallback<GetShipmentsResponse> {
	...
	public ApiCallbackGetShipments(IFulfillmentInboundService iFulfillmentInboundService,IShipInboundShipmentService iShipInboundShipmentService, AmazonAuthority auth,
			Marketplace market) {
		// TODO Auto-generated constructor stub
		this.iFulfillmentInboundService=iFulfillmentInboundService;
		this.iShipInboundShipmentService=iShipInboundShipmentService;
		this.auth=auth;
		this.market=market;
	}
	...
	public void onSuccess(GetShipmentsResponse result, int statusCode, Map<String, List<String>> responseHeaders) {
		...
		iShipInboundShipmentService.handlerResult(auth,market,result);
	}
