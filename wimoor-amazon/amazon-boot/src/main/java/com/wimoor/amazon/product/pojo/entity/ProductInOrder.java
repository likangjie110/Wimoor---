...
public class ProductInOrder implements Serializable {
    ...
    @ApiModelProperty(value = "30日退货订单")
    @TableField(value= "`sales_return_month`")
    private Integer salesReturnMonth;

    @ApiModelProperty(value = "30日退货订单")
    @TableField(value= "`order_return_month`")
    private Integer orderReturnMonth;
