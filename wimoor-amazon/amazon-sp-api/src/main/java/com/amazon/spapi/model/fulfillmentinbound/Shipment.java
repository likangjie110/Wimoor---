...
public class Shipment {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amazonReferenceId, contactInformation, dates, destination, inboundPlanId, name, palletInformation, placementOptionId, selectedTransportationOptionId, selfShipAppointmentDetails, shipmentConfirmationId, shipmentId, source, status, trackingDetails);
  }
