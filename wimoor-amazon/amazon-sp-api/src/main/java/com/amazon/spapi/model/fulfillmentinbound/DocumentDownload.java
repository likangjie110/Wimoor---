...
public class DocumentDownload {
   ...
   * @return downloadType
  **/
  @ApiModelProperty(required = true, value = "The type of download. Can be `URL` or `PDF_BASE64`.")
   ...
   * @return expiration
  **/
  @ApiModelProperty(value = "The timestamp of expiration of the URI. This is in ISO 8601 datetime format with pattern `yyyy-MM-ddTHH:mm:ss.sssZ`.")
