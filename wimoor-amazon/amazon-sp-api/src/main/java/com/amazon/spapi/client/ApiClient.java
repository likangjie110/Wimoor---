...
public class ApiClient {
    ...
    public ApiClient(RateLimitConfiguration rateLimitConfiguration) {
        ...
        if (rateLimitConfiguration != null) {
            ...
            builder.addInterceptor(rateLimiterInterceptor);
        }
        if(rateLimitConfiguration.proxyHost()!=null&&rateLimitConfiguration.proxyPort()!=null) {
            builder.proxy(new Proxy(Proxy.Type.HTTP, new InetSocketAddress(rateLimitConfiguration.proxyHost(), rateLimitConfiguration.proxyPort())));
        }
