...
import com.amazon.spapi.model.finances.ChargeRefundTransaction;
 ...
 */
@ApiModel(description = "A list of `ChargeRefund` transactions.")
...
public class ChargeRefundTransactions extends ArrayList<ChargeRefundTransaction> {
  ...
  public String toString() {
    ...
    sb.append("class ChargeRefundTransactions {\n");
