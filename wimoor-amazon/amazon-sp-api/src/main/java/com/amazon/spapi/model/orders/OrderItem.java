...
import com.amazon.spapi.model.orders.AssociatedItem;
...
import com.amazon.spapi.model.orders.SubstitutionPreferences;
...
public class OrderItem {
  ...
  **/
  @ApiModelProperty(value = "The start date of the scheduled delivery window in the time zone of the order destination. In <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> date time format.")
  ...
  **/
  @ApiModelProperty(value = "The end date of the scheduled delivery window in the time zone of the order destination. In <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> date time format.")
