...
public class InboundPlan {
  ...
  public InboundPlan contactInformation(ContactInformation contactInformation) {
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "The human-readable name of the inbound plan.")
  ...
  **/
  @ApiModelProperty(value = "Packing options for the inbound plan. This property will be populated when it has been generated via the corresponding endpoint. If there is a chosen placement option, only packing options for that placement option will be returned. If there are confirmed shipments, only packing options for those shipments will be returned. Query the packing option for more details.")
  ...
  **/
  @ApiModelProperty(value = "Placement options for the inbound plan. This property will be populated when it has been generated via the corresponding endpoint. If there is a chosen placement option, that will be the only returned option. Query the placement option for more details.")
   ...
   * @return shipments
  **/
  @ApiModelProperty(value = "Shipment IDs for the inbound plan. This property will be populated when it has been generated via the corresponding endpoint. If there is a chosen placement option, only shipments for that option will be returned. If there are confirmed shipments, only those shipments will be returned. Query the shipment for more details.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.contactInformation, inboundPlan.contactInformation) &&
        Objects.equals(this.createdAt, inboundPlan.createdAt) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(contactInformation, createdAt, inboundPlanId, lastUpdatedAt, marketplaceIds, name, packingOptions, placementOptions, shipments, sourceAddress, status);
  }
