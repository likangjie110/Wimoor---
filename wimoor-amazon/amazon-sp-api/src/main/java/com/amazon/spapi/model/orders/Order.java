...
import com.amazon.spapi.model.orders.EasyShipShipmentStatus;
import com.amazon.spapi.model.orders.ElectronicInvoiceStatus;
...
public class Order {
  ...
  **/
  @ApiModelProperty(value = "The start of the time period within which you have committed to fulfill the order. In <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> date time format. Returned only for seller-fulfilled orders.")
