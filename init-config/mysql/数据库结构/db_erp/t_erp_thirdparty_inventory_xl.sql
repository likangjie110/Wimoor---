...
CREATE TABLE IF NOT EXISTS `t_erp_thirdparty_inventory_xl` (
  ...
  `packagetype` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=1993473798546276354 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
