...
-- 导出  表 db_amazon.t_erp_ship_v2_inboundplan_pallet 结构
CREATE TABLE IF NOT EXISTS `t_erp_ship_v2_inboundplan_pallet` (
  ...
  `dim_unit` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `weight` decimal(20,2) DEFAULT NULL,
  `weight_unit` char(50) COLLATE utf8mb4_bin DEFAULT NULL,
