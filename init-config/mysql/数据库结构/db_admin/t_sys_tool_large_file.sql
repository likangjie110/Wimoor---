...
-- 导出  表 db_admin.t_sys_tool_large_file 结构
CREATE TABLE IF NOT EXISTS `t_sys_tool_large_file` (
  ...
  UNIQUE KEY `idx_location` (`location`(191)) USING BTREE,
  KEY `ftype_shopid` (`shopid`,`ftype`,`location`)
