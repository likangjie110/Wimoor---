...
function getShipmentDetailReport(data){ 
	 return request.post('/amazon/api/v2/ship/report/getShipmentDetailReport',data);
}
function getShipmentReport(data){ 
	 return request.post('/amazon/api/v2/ship/report/getShipmentReport',data);
}
 function downShipmentExcel(data,callback){
 	return request({url:"/amazon/api/v2/ship/report/downShipmentExcel",
 				                    responseType:"blob",
 									data:data,
 ...
 function downExcelShipmentReportByLoistics(data,callback){
 	return request({url:"/amazon/api/v2/ship/report/downExcelShipmentReportByLoistics",
 				                    responseType:"blob",
 									data:data,
 									method:'post'}).then(res => {
