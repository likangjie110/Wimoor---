						  ...
						  <el-col :span="16">
							  ...
							  <el-table :data="feetableData">
								   <el-table-column prop="itemname" label="费用名称"  >
									   ...
									   <el-select style="width:200px" v-else v-model="scope.row.itemid">
										   <el-option
								  ...
								  <el-table-column label="日期" prop="byday" width="250">
								   ...
								   <el-table-column prop="currency" label="货币"  >
									   ...
									   <el-select v-else style="width:130px" v-model="scope.row.currency">
											   <el-option
								   ...
								   <el-table-column prop="itemname" label="操作"  width="100"  >
									   <template #default="scope">
