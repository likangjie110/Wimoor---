<template>
	<el-row>
		<el-space>
			...
			<el-input v-model="queryParams.search" @input="handleQuery" placeholder="搜索否定投放">
					 <template #suffix>
	 ...
	 <GlobalTable  ref="globalTable" :tableData="tableData"
	   ...
	   >
		  ...
		  <el-table-column  fixed type="selection" width="60" />
		   <el-table-column fixed    label="商品投放"  width="200"  sortable="custom"   prop="targetingText">
			...
			<el-table-column     label="匹配类型"  width="200" >
				   <template #default="scope">
						...
						<span v-if="scope.row.matchType=='negativeBroad'">广泛匹配</span>
...
<script setup>
	...
	import {loadList,handleSubmitUpdate,} from '../javascript/neTarget.js';
