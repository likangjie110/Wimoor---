<template>
	<el-form-item >
		<div class="flex-center" >
			...
			<el-tab-pane label="排除品牌" name="ASIN_BRAND_SAME_AS">
			...
			<el-tab-pane label="排除ASIN" name="ASIN_SAME_AS">
		  <el-input
		    v-model="asins"
		    type="textarea"
...
<script setup>
	...
	function addBrand(item){
		if(state.addList.includes(item)==false){
			var row={"type":state.activeName,"value":item.id,"name":item.name};
