	...
	<el-form-item label="定向策略" prop="target">
		<div style="width:90%;" >
			...
			<div class="flex-center"   v-if="targetType=='keyword'">
				   <TargetKeyword ref="targetKeywordRef" :param="param" @change="emitChange"></TargetKeyword>
			</div>

			<div class="flex-center" v-if="targetType=='target'">
				  <TargetProduct ref="targetProductRef" :param="param" @change="emitChange"></TargetProduct>
			</div>
