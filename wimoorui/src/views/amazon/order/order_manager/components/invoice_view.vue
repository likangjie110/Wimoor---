<template>
	...
	<!-- 预览发票信息 -->
	<el-dialog v-model="lookvatVisible"   title="预览发票详情" top="1vh" width="80%"  @close='closeDialog'>
		<div style="border: 1px solid #5A5E66;" v-if="invoiceData1" v-loading="orderloading">
		   ...
		   <el-descriptions :column="2"  >
		   				 ...
		   				 <el-descriptions-item :span="1" align="right" >
		   				 			 <span style="padding-right: 20px;font-size: 18px;font-weight: bolder;">Paid </span>
		   				 </el-descriptions-item>  
		   </el-descriptions>
		   <el-descriptions :column="2"  >
				  <el-descriptions-item :span="1" align="left"  >
		  ...
		  <el-table :data="productData.list" border class="od-table" style="margin-bottom: 20px;">
		  	<el-table-column prop="name" label="Invoice Details"    >
		  ...
		  <el-descriptions :column="1"  >
		  			   <el-descriptions-item :span="1" align="right" label="Invoice Total:">
...
<script setup>
	...
	function show(row,mvattype,mvatlabel,mordertype){
	...
	function loadOrderDetail(orderid,buydate,groupid,nonaddress,nonfin,isdeep){
		...
		orderListApi.showOrderDetail({
			...
			if(res.data){
				...
				vatNo.value=productData.list[0].invoiceNo;
