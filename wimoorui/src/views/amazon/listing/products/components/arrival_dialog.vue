...
<script>
	...
	export default{
		setup(){
			...
			function saleChart(){
				var myChart = echarts.init(document.getElementById('shipchart'))
				var myseries=[];
			...
			function loadChart(groupid,marketplaceid,amazonAuthId,sku,msku){
			...
			return{
				//value
				arrivalVisible,productData,activeMarket,spacer,radiotime,marketList,
				//ref
				
				//function
				saleChart,loadChart,handleClick,changeTimeType
			}
		}
	}
</script>
