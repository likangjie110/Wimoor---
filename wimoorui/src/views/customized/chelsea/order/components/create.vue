...
<script setup>
	...
	const state =reactive({
		...
		countrySearch:[
			{value: '美国'},{value: '英国'},{value: '加拿大'},{value: '墨西哥'},{value: '巴西'},
			{value: '澳大利亚'},{value: '德国'},{value: '西班牙'},{value: '法国'},{value: '意大利'},
			{value: '荷兰'},{value: '波兰'},{value: '瑞典'},{value: '比利时'},{value: '沙特'},
			{value: '土耳其'},{value: '阿联酋'},{value: '新西兰'},{value: '新加坡'},{value: '印度'},
			{value: '埃及'},{value: '日本'},{value: '中国'},
		]
	})
	const {
		visible,options,formData,countrySearch
	}=toRefs(state)
	function show(){
		state.visible=true;
		loadData();
	...
	function handleSelect(item){
		state.formData.country=item.value;
	}
	defineExpose({
		show,
	})
