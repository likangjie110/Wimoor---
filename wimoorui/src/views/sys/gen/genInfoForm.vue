    ...
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item prop="packageName">
          <template #label>
            生成包路径
            <el-tooltip content="生成在哪个java包下，例如 com.wimoor.system" placement="top">
...
<script setup>
import {listCompanyMenuTree, listMenus} from "@/api/sys/admin/menu.js"
...
function getMenuTreeselect() {
  listCompanyMenuTree().then(response => {
