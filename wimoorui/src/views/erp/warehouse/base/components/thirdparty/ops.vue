	...
	<el-scrollbar class="localoversea">
						  <el-row style="padding-bottom:20px">
							...
							<el-table :data="invlist" style="width: 100%" height="calc(100vh - 200px)">
										  ...
										  <el-table-column prop="quantity" label="可用库存"   width="100"  sortable  />
										  <el-table-column prop="length" label="长"   width="60"   sortable />
										  <el-table-column prop="width" label="宽"   width="60" sortable />
										  <el-table-column prop="height" label="高"   width="60"   sortable />
										  <el-table-column prop="weight" label="重"  width="60"    sortable />
										  <el-table-column prop="vol" label="体积"   width="100"   sortable />
										  <el-table-column prop="packagetype" label="类型"   width="100"   sortable />
										</el-table>	
	  </el-scrollbar>
</template>
