        ...
        <el-row>
			<GlobalTable ref="globalTable"
			 ...
			 style="width: 100%;margin-bottom:16px;">
				<template #field>
					<el-table-column prop="returntime"  label="充退时间" sortable="custom" >
				...
				<el-table-column prop="amount"  label="充退金额(元)"  sortable="custom" >
				</el-table-column>
				 <el-table-column prop="returntype"   label="充退去向" sortable="custom" >
				</el-table-column>
			<el-table-column prop="number"  label="充退支付宝流水号" sortable="custom" >
			</el-table-column>
			</template>
			</GlobalTable>
        </el-row>
