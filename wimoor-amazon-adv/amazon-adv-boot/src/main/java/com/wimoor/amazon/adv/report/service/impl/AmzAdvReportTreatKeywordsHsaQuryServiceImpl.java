		...
		// TODO Auto-generated method stub
			...
			try {
				...
				while (jsonReader.hasNext()) {
					...
					String query = item.getString("searchTerm");
					...
					amzAdvReportKeywordsQueryHsa.setAttributedsales14d(item.getBigDecimal("sales"));
					amzAdvReportKeywordsQueryHsa.setAttributedconversions14d(item.getInteger("purchases"));
					amzAdvReportKeywordsQueryHsa.setAttributedUnitsOrdered14d(item.getInteger("unitsSold"));
