...
public class AmzAdvCampaignsHsa {
	...
	public Boolean getMultiAdGroupsEnabled() {
		return isMultiAdGroupsEnabled;
	}

	public void setMultiAdGroupsEnabled(Boolean multiAdGroupsEnabled) {
		isMultiAdGroupsEnabled = multiAdGroupsEnabled;
	}

	@Transient
	private Date lastUpdatedDate;

	@Column(name="isMultiAdGroupsEnabled")
