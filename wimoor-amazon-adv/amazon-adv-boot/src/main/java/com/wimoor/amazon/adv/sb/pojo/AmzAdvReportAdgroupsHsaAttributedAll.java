...
/**
 * 亚马逊广告HSA广告组归因报告
 * @TableName t_amz_adv_rpt2_hsa_adgroups_attributed_all
 */
@TableName(value ="t_amz_adv_rpt2_hsa_adgroups_attributed_all")
@Data
public class AmzAdvReportAdgroupsHsaAttributedAll implements Serializable {
    /**
     * 广告组ID
     */
