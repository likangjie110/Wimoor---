...
import com.wimoor.amazon.adv.sb.service.*;
...
public class AmzAdvSnapshotHandlerApiServiceImpl implements IAmzAdvSnapshotHandlerApiService {
		...
		// TODO Auto-generated method stub
				...
				try {
					...
					if(page!=null&&page.getNexttoken()==null&&page.getOpttime()!=null&&GeneralUtil.distanceOfHour(page.getOpttime(), new Date())<20) {
						...
						param.put("nextToken", null);
						iAmzAdvBudgetRulesService.amzGetBudgetRules(profile,param,"SP");	
						if(param.get("nextToken")!=null) {
							amzAdvApiPagesService.savePage(profile.getId(),api,param.get("nextToken").toString());
						}else {
							amzAdvApiPagesService.savePage(profile.getId(),api,null);
		...
		// TODO Auto-generated method stub
				...
				try {
					...
					if(page!=null&&page.getNexttoken()==null&&page.getOpttime()!=null&&GeneralUtil.distanceOfHour(page.getOpttime(), new Date())<20) {
						...
						param.put("nextToken", null);
						iAmzAdvBudgetRulesService.amzGetBudgetRules(profile,param,"SB");	
						if(param.get("nextToken")!=null) {
							amzAdvApiPagesService.savePage(profile.getId(),api,param.get("nextToken").toString());
						}else {
							amzAdvApiPagesService.savePage(profile.getId(),api,null);
		...
		// TODO Auto-generated method stub
				...
				try {
					...
					if(page!=null&&page.getNexttoken()==null&&page.getOpttime()!=null&&GeneralUtil.distanceOfHour(page.getOpttime(), new Date())<20) {
						...
						param.put("nextToken", null);
						iAmzAdvBudgetRulesService.amzGetBudgetRules(profile,param,"SD");	
						if(param.get("nextToken")!=null) {
							amzAdvApiPagesService.savePage(profile.getId(),api,param.get("nextToken").toString());
						}else {
							amzAdvApiPagesService.savePage(profile.getId(),api,null);
	...
	public void requestCampBudgetRule(AmzAdvProfile profile) {
		...
		example.createCriteria().andEqualTo("profileid", profile.getId());
		List<AmzAdvBudgetRules> list = iAmzAdvBudgetRulesService.selectByExample(example);
		for(AmzAdvBudgetRules item:list) {
		  iAmzAdvBudgetRulesService.amzGetBudgetRules(profile,item);	
		}
