...
/**
 * 
 * @TableName t_amz_adv_rpt2_sd_productads_attributed_all
 */
@TableName(value ="t_amz_adv_rpt2_sd_productads_attributed_all")
@Data
public class AmzAdvReportProductadsSDAttributedAll implements Serializable {
    /**
     * 
     */
    @TableId(value = "adId")
