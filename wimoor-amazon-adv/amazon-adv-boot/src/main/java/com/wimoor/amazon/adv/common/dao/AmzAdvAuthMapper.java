...
public interface AmzAdvAuthMapper extends BaseMapper<AmzAdvAuth>{
	...
	Map<String, Object> getProfileByGroupAndmarkplace(@Param("groupid")String groupid, @Param("marketplaceid")String marketplaceid, @Param("profileid")String profileid);
