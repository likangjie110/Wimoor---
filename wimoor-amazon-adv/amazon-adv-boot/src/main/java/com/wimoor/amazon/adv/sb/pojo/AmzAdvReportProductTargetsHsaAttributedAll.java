...
/**
 * 亚马逊广告HSA商品定位归因报告(全量)
 * @TableName t_amz_adv_rpt2_hsa_product_targets_attributed_all
 */
@TableName(value ="t_amz_adv_rpt2_hsa_product_targets_attributed_all")
@Data
public class AmzAdvReportProductTargetsHsaAttributedAll implements Serializable {
    /**
     * 商品定位ID
     */
