...
/**
 * 亚马逊广告HSA广告归因报告
 * @TableName t_amz_adv_rpt2_hsa_ads_attributed_all
 */
@TableName(value ="t_amz_adv_rpt2_hsa_ads_attributed_all")
@Data
public class AmzAdvReportAdsHsaAttributedAll implements Serializable {
    /**
     * 广告ID
     */
    @TableId(value = "adId")
