...
/**
 * 亚马逊广告HSA广告活动归因报告
 * @TableName t_amz_adv_rpt2_hsa_campaigns_attributed_all
 */
@TableName(value ="t_amz_adv_rpt2_hsa_campaigns_attributed_all")
@Data
public class AmzAdvReportCampaignsHsaAttributedAll implements Serializable {
    /**
     * 广告活动ID
     */
     ...
     * 操作时间
     */
    @TableField(value = "oipttime")
    private Date oipttime;
    ...
    public boolean isZero() {
        return (addToCart == null || addToCart == 0) &&
                ...
                (topOfSearchImpressionShare == null || topOfSearchImpressionShare.floatValue() < 0.001f) &&
