...
public class SchedulingConfigController {
	...
	@GetMapping("/requestReportByDate")
	public Result<?> requestReport(String authid,String start,String end){
		amzAdvReportHandlerService.requestReportByDate(authid,start,end);
		return Result.success();
	}
	...
	public Result<?> listReport(String authid){
		return Result.success(amzAdvReportHandlerService.listReport(authid));
	}
