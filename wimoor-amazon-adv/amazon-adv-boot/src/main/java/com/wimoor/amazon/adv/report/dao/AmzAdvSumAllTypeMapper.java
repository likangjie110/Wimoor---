...
/*    int deleteByPrimaryKey(AmzAdvSumAllTypeKey key);
	...
	List<Map<String, Object>> selectSPAdvSummaryNums(@Param("param") QueryForList param);
	List<Map<String, Object>> selectSBAdvSummaryNums(@Param("param") QueryForList param);
	List<Map<String, Object>> selectSDAdvSummaryNums(@Param("param") QueryForList param);
}