...
public interface IAmzAdvCampaignService extends IService<AmzAdvCampaigns>{
	 ...
	 * @return 
     */
	public List<AmzAdvCampaigns> amzUpdateSpCampaigns(UserInfo user,BigInteger  profileId,  JSONArray campaignsList);
	...
	public List<AmzAdvCampaigns> deleteCampaigns(UserInfo user, BigInteger bigInteger, JSONObject param);

	public List<AmzAdvCampaigns> amzCreateSpCampaigns(UserInfo user, BigInteger key, JSONArray jsonArray);

	public String amzGetCampaignBudgetUsage(UserInfo user, BigInteger bigInteger, JSONObject param);
