...
public class MaterialVO  extends ErpBaseEntity{
    ...
    @ApiModelProperty(value = "带包装图片ID")
    @TableField(value = "pkgimage")
    private String pkgimage;

    @ApiModelProperty(value = "包装图片")
    ...
    @TableField(exist=false)
    @ApiModelProperty(value = "产品包装图片数据")
    Object pkgimgfile;
	...
	@ApiModelProperty(value = "带包装的产宽高重")
	DimensionsInfoVo pkgdimension;
	
	@ApiModelProperty(value = "箱规")
	DimensionsInfoVo boxdimension;
	
	List<MaterialConsumableVO> conList;
}