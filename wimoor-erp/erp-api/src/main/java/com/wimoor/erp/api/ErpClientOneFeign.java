...
public interface ErpClientOneFeign {
	...
	@GetMapping("/erp/api/v1/shipTransCompany/getTransDetail")
	public Result<?> getTransDetail(@RequestBody Map<String,Object> params);
	...
	@PostMapping("/erp/api/v1/order/ozon/upsert")
	public Result<OzonErpOrderUpsertResult> upsertOzonOrder(@RequestBody OzonErpOrderUpsertCommand command);
}
