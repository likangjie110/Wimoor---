...
@ApiModel(value="OverseaReportDTO", description="海外仓发货单报告")
public class OverseaReportDTO extends BasePageQuery {
        ...
        @ApiModelProperty(value = "海外仓库ID", example = "A1AM78C64UM0Y8")
        String towarehouseid ;

        @ApiModelProperty(value = "仓库ID", example = "123456789")
        String warehouseid ;

        @ApiModelProperty(value = "FBA仓库")
        String fbacenter;

        @ApiModelProperty(value = "授权店铺ID【系统填充】")
        List<String> groupList ;

        @ApiModelProperty(value = "checkdown")
        List<String> checkdown ;
