...
public class AssemblyFormEntryServiceImpl extends  ServiceImpl<AssemblyFormEntryMapper,AssemblyFormEntry>  implements IAssemblyFormEntryService {
	...
	public List<Map<String, Object>> selectByFormid(String formid,String shopid) {
		return this.baseMapper.selectByFormid(formid,shopid);
	}
	...
	public List<Map<String, Object>> selectAssemblyFormByPurchaseEntryId(String entryid,String shopid) {
	    ...
	    for(Map<String, Object> item:formlist) {
	    	List<Map<String, Object>> entrylist =  this.baseMapper.selectByFormid(item.get("formid").toString(),shopid);
