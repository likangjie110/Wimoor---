...
public class OrderController {
    ...
    private final OzonOrderBridgeService ozonOrderBridgeService;
    ...
    @PostMapping("/ozon/upsert")
    public Result<OzonErpOrderUpsertResult> upsertOzonOrderAction(@RequestBody OzonErpOrderUpsertCommand command) {
        return Result.success(ozonOrderBridgeService.upsert(command));
    }
