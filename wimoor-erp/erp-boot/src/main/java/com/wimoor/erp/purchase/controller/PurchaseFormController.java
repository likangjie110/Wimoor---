...
public class PurchaseFormController {
	...
	final IInventoryFormAgentService iInventoryFormAgentService;
	...
	public Result<List<PurchaseFormReceiveVo>> getReceiveReport(@RequestBody ReceiveReportDTO condition){
		...
		public Result<Object> refreshAlibabaOrderAction() throws BizException {
			...
			try {
				iInventoryFormAgentService.refreshInventoryTask();
			}catch(Exception e) {
				e.printStackTrace();
			}
			return Result.success();
		...
		public Result<Map<String, Object>> getAssemblyInfoAction(String id) {
			...
			List<Map<String, Object>> assemblyformlist=assemblyFormEntryService.selectAssemblyFormByPurchaseEntryId(id,shopid);
