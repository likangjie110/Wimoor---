...
public class HttpClientUtil {
	...
	public static String postUrl(String url, String param, Map<String, String> header) throws HttpException {
		HttpPost httpPost = null;
		CloseableHttpClient client = null;
		try {
			httpPost = new HttpPost(url);
	...
	public static HttpResponse postResponseUrl(String url, String param, Map<String, String> header) throws HttpException {
		HttpPost httpPost = null;
		CloseableHttpClient client = null;
		try {
			httpPost = new HttpPost(url);
