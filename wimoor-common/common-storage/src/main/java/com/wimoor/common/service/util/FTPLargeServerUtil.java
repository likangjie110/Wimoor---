...
@Component
@ConfigurationProperties(prefix = "large.ftp")
public class FTPLargeServerUtil {
    @Setter
    String ftpUserName;
...
//	            flag = getDefaultFtpClient().makeDirectory(dir);
	...
	public  void getObject(String bucketName, String objectName, ObjectHandler handler, Map<String,Object> param)  {
		try {
			ftpClient=getFTPClient();
            //切换FTP目录
			ftpClient.changeWorkingDirectory(bucketName);
			FTPFile[] ftpFiles = ftpClient.listFiles();
			for(FTPFile file : ftpFiles){
				if(objectName.equalsIgnoreCase(file.getName())){
